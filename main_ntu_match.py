...
class Processor():
    ...
    def __init__(self, arg):
        ...
        self.action_descriptions = torch.load('/DATA3/cy/STAR/data/text_feature/ntu120_semantic_feature_dict_gpt35.tar')
        _ = torch.load('/DATA3/cy/STAR/data/text_feature/ntu_spatial_attribute_feature_dict_gpt35.tar')
        self.attribute_features_dict = torch.load('/DATA3/cy/STAR/data/text_feature/ntu_spatial_temporal_attribute_feature_dict_gpt35.tar')
