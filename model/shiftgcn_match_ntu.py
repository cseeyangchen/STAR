...
class ModelMatch(nn.Module):
    ...
    def loss_cal(self, part_visual, global_visual, part_language, part_language_seen,part_language_seen_unseen,
        ...
        np.save('/DATA3/cy/STAR/tsen_feature/semantic_space/action_name.npy', all_label_language.detach().cpu().numpy())
        ...
        for i in range(6):
            ...
            np.save('/DATA3/cy/STAR/tsen_feature/semantic_space/part_description_{}.npy'.format(i), tmp.detach().cpu().numpy())
